...
| `UnorderedElementsAre(e0, e1, ..., en)` | `argument` has `n + 1` elements, and under *some* solution of the elements, each element matches an `ei` (for a different `i`), which can be a value or a matcher. |
